...
public class Hierarchy<T> implements DFSActions<T> {
    ...
    // Method called when processing a vertex, appends the vertex to the
    // representation
    @Override
    ...
    // Method called when descending into a vertex, no specific action for Hierarchy
    // representation
    @Override
    ...
    // Method called when ascendfving from a vertex, no specific action for
    ...
    // Overrides the toString method to return the representation string, trimming
